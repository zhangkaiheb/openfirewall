...
unless (defined($proxysettings{'NCSA_EDIT_MODE'}) && $proxysettings{'NCSA_EDIT_MODE'} eq 'yes') {
    ...
    &Header::openbox('100%', 'left', "$Lang::tr{'cache management'}", $error_options);
...
<tr>
    ...
    <td class='button2buttons'><input type='submit' class='commonbuttons' name='ACTION' value='$Lang::tr{'clear cache'}' /></td>
