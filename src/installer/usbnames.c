/*
 * gesp 2010-12-17: import names.c into installer/setup/usbnames.c from usbutils-001 with changes
 * config.h to usbutils.h (without ifdef HAVE_CONFIG_H)
 * names.h to usbnames.h
 * undef VERSION
 * 
 * $Id: usbnames.c 5360 2011-01-20 07:24:21Z gespinasse $
 */
...
#ifdef VERSION
/* undef VERSION from command line to avoid warning in usbutils.h */
#undef VERSION
#endif
/* owes: config.h to usbutils.h */
#include "usbutils.h"
